const SHOWS = [
  ...
  },
  {
    ...
    year: '2015–',
    description:
      'A family of adult siblings find that their secrets and scars are revealed when their black sheep of a brother returns home.',
    poster: 'bl.jpg',
    imdbID: 'tt3520702',
    trailer: 'tRnS8FkcXNk',
  },
  ...
  },
  {
    ...
    year: '2016–',
    description:
      'Will Arnett will star as a self-help guru who needs a decent amount of help himself.',
    poster: 'f.jpg',
    imdbID: 'tt4973548',
    trailer: 'iKOpvm7BcOo',
  },
...
searchBar.addEventListener('input', event => {
  ...
  loadShowsInfo(filteredShowList);
});

function loadShowsInfo(shows = SHOWS) {
